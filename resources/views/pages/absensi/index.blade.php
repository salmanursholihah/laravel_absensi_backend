            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="float-right">
                        ...
                        <form method="GET" action="{{ route('attendances.index') }}" class="card-body">
                            <div class="form-control"> <input type="text" name="name" placeholder="Nama User"
                                    value="{{ request('name') }}">
                            </div>
                            ...
                            <div class="form-control"> <input type="date" name="start_date"
                                    value="{{ request('start_date') }}">
                            </div>
                            <div class="form-control"><input type="date" name="end_date"
                                    value="{{ request('end_date') }}"></div>
                            <div class="form-control"> <select name="filter">
