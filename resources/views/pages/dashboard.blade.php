...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet"
        href="{{ asset('backend/asset/library/jqvmap/dist/jqvmap.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('backend/asset/library/summernote/dist/summernote-bs4.min.css') }}">
@endpush
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    <img class="rounded-circle mr-3"
                                        width="50"
                                        src="{{ asset('backend/asset/img/avatar/avatar-1.png') }}"
                                        alt="avatar">
                                ...
                                <li class="media">
                                    <img class="rounded-circle mr-3"
                                        width="50"
                                        src="{{ asset('backend/asset/img/avatar/avatar-2.png') }}"
                                        alt="avatar">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="rounded-circle mr-3"
                                        width="50"
                                        src="{{ asset('backend/asset/img/avatar/avatar-3.png') }}"
                                        alt="avatar">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="rounded-circle mr-3"
                                        width="50"
                                        src="{{ asset('backend/asset/img/avatar/avatar-4.png') }}"
                                        alt="avatar">
                                    <div class="media-body">
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('backend/asset/library/simpleweather/jquery.simpleWeather.min.js') }}"></script>
    <script src="{{ asset('backend/asset/library/chart.js/dist/Chart.min.js') }}"></script>
    <script src="{{ asset('backend/asset/library/jqvmap/dist/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('backend/asset/library/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>
    <script src="{{ asset('backend/asset/library/summernote/dist/summernote-bs4.min.js') }}"></script>
    <script src="{{ asset('backend/asset/library/chocolat/dist/js/jquery.chocolat.min.js') }}"></script>

    <!-- Page Specific JS File -->
    <script src="{{ asset('backend/asset/js/page/index-0.js') }}"></script>
@endpush
